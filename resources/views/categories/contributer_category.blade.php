    ...
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <body>
            @if(!is_null($posts[0]))
                ...
                <div class='footer'>
                    <div>{{ $posts->links() }}</div>
                    <a href="/posts/{{$country->code}}/contributer/{{$user_id}}" class="back_btn">戻る</a>
                </div>
            @else
                <div class='no_posts'>
                ...
                <div class='footer'>
                    <a href="/posts/{{$country->code}}/contributer/{{$user_id}}" class="no_posts_back_btn">戻る</a>
                </div>
            @endif
        </body>
    </html>
